...
test.describe('/book — Regiondo widget integration', () => {
  test('page metadata and branded header intact', async ({ page }) => {
    ...
    await expect(page).toHaveTitle(/Petit Train de Vannes/)
  ...
  // TODO: update REGIONDO_WIDGET_ID once client provides real Vannes widget ID
  test.skip('Regiondo custom element is in the DOM', async ({ page }) => {
    await page.goto('/book')
  ...
  // TODO: update REGIONDO_WIDGET_ID once client provides real Vannes widget ID
  test.skip('Regiondo script is loaded by Next.js', async ({ page }) => {
    await page.goto('/book')
