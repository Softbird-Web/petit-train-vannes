export const metadata = {
  ...
  description:
    'Politique de confidentialité du Petit Train de Vannes. Informations sur la collecte et le traitement des données personnelles, cookies et droits des utilisateurs.',
      ...
      <section className="bg-[#ffffff] py-16 xl:py-24 px-5 xl:px-[64px]">
        <div className="max-w-[800px] mx-auto flex flex-col gap-10">
          ...
          <div className="flex flex-col gap-4">
            <h2 className="font-normal font-['Bricolage_Grotesque',sans-serif] text-[24px] text-[#1c1b29] tracking-[-1px] leading-[1.3]">
            ...
            <p className="font-['Manrope',sans-serif] text-[#535862] text-base leading-[1.7] tracking-[-0.3px]">
              La présente Politique vous informe sur la façon dont Le Petit Train de Vannes, ses
          ...
          <div className="flex flex-col gap-4">
            ...
            <h3 className="font-['Manrope',sans-serif] font-semibold text-[#1c1b29] text-base tracking-[-0.3px]">
              Quels cookies utilisons-nous ?
            </h3>
            <div className="overflow-x-auto">
              <table className="w-full font-['Manrope',sans-serif] text-sm text-[#535862] border-collapse">
                <thead>
                  <tr className="border-b border-[rgba(28,27,41,0.12)]">
                    <th className="text-left py-2 pr-4 text-[#1c1b29] font-semibold whitespace-nowrap">Nom</th>
                    <th className="text-left py-2 pr-4 text-[#1c1b29] font-semibold whitespace-nowrap">Type</th>
                    <th className="text-left py-2 pr-4 text-[#1c1b29] font-semibold whitespace-nowrap">Durée</th>
                    <th className="text-left py-2 text-[#1c1b29] font-semibold">Description</th>
                  </tr>
                </thead>
                <tbody>
                  {[
                    ...
                    <tr key={cookie.name} className="border-b border-[rgba(28,27,41,0.08)]">
                      <td className="py-2.5 pr-4 font-mono text-xs text-[#f7a427] whitespace-nowrap">{cookie.name}</td>
          ...
          <PrivacySection title="Comment exercer vos droits">
            ...
            Protection des Données de Le Petit Train de Vannes par courrier signé accompagné
          ...
          <div className="flex flex-col gap-3">
            ...
            <p className="font-['Manrope',sans-serif] text-[#535862] text-base leading-[1.7] tracking-[-0.3px]">
              Le Petit Train de Vannes ne traite les données personnelles que pour des finalités
            ...
            <div className="border-t border-[rgba(28,27,41,0.12)] mt-1" />
          </div>
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="overflow-x-auto">
              <table className="w-full font-['Manrope',sans-serif] text-sm text-[#535862] border-collapse">
                <thead>
                  <tr className="border-b border-[rgba(28,27,41,0.12)]">
                    <th className="text-left py-2 pr-4 text-[#1c1b29] font-semibold">Nom</th>
                    <th className="text-left py-2 pr-4 text-[#1c1b29] font-semibold">Usage</th>
                    <th className="text-left py-2 text-[#1c1b29] font-semibold">Hors UE</th>
                  </tr>
                </thead>
                <tbody>
                  <tr className="border-b border-[rgba(28,27,41,0.08)]">
                    <td className="py-2.5 pr-4 font-medium text-[#1c1b29]">OVH</td>
                    <td className="py-2.5 pr-4">Hébergement du site</td>
                    <td className="py-2.5">Non</td>
                  </tr>
                  <tr className="border-b border-[rgba(28,27,41,0.08)]">
                    <td className="py-2.5 pr-4 font-medium text-[#1c1b29]">Google Analytics</td>
