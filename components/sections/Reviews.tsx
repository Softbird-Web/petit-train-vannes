...
export default function Reviews() {
  ...
  return (
    <section data-anim-section className="bg-[#f5ebdd] flex flex-col gap-10 xl:gap-14 items-center justify-center py-20 overflow-hidden">
      {/* Header */}
      <div className="max-w-[1280px] mx-auto px-5 xl:px-0 w-full flex justify-center">
        <div className="flex flex-col gap-6 items-center text-center max-w-[623px]">
          ...
          <h2 data-anim-item className="font-normal font-['Bricolage_Grotesque',sans-serif] text-[#1c1b29] text-[32px] sm:text-[40px] md:text-[48px] text-center leading-[1.2] tracking-[-1.5px] sm:tracking-[-2.5px] md:tracking-[-3.36px] max-w-[410px] w-full [text-wrap:balance] break-words">
            {t("heading")}
          </h2>

          <p data-anim-item className="font-['Manrope',sans-serif] text-[#1c1b29] text-[16px] text-center leading-[1.2] tracking-[-0.48px] max-w-[570px] w-full">
            {t("description")}
          </p>
          ...
          <div data-anim-item className="bg-white rounded-[8px] flex items-center gap-2.5 px-2 py-1 rotate-[0.54deg]">
            <div className="relative shrink-0 w-6 h-6">
              <Image src="/figma-assets/google-icon.svg" alt="Google" fill sizes="64px"
